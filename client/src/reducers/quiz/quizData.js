export default {
    ...
    questions: [
        ...
        {
            qid: 1,
            question: 'True or False - Pat was extremely nervous for their first kiss',
            choices: [
        ...
        // TODO: revise this question
        {
            ...
            answer: 'a',
            imgName: 'glasses',
            rewardBlurb: 'They lived together on and off until January 4, 2015. Pat graduated from IU before Sam did and moved to Indy then Chicago for work. Sam stayed in Bloomington and then lived in Ireland for 3 months.',
						completed: false,
